...
ensm_givenhyperpar <- function(C, X, A_block, L, max_iter, 
  ...
  source("src/fun_likelihood.R")
	...
	sigma2_laplace <- hyperpar[7]

	tmp <- ensm_cluster_mean(C, X, A_block, L = L, 
             ...
             update_sigma2_ = FALSE, starting_sigma2_ = sigma2_laplace)
